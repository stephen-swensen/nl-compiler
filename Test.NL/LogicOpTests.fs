...
let ``lhs of and  must be bool`` options =
    raisesWith 
        <@ C.evalWith options "3 && true" @>
        (expectedErrors [|6|])

[<Theory;EvalData>]
let ``rhs of and  must be bool`` options =
    raisesWith 
        <@ C.evalWith options "true && 3" @>
        (expectedErrors [|6|])

[<Theory;EvalData>]
let ``true and true`` options =
    test <@ C.evalWith options "true && true" = true @>

[<Theory;EvalData>]
let ``true and false`` options =
    test <@ C.evalWith options "true && false" = false @>

[<Theory;EvalData>]
let ``false and true`` options =
    test <@ C.evalWith options "false && true" = false @>

[<Theory;EvalData>]
let ``false and false`` options =
    test <@ C.evalWith options "false && false" = false @>
...
let ``true or false`` options =
    test <@ C.evalWith options "true || false" = true @>

[<Theory;EvalData>]
let ``false or true`` options =
    test <@ C.evalWith options "false || true" = true @>
...
//    raisesWith 
//        <@ C.evalWith options "3 xor true" @>
//        (expectedErrors [|6|])

//[<Theory;EvalData>]
//let ``rhs of xor  must be bool`` options =
//    raisesWith 
//        <@ C.evalWith options "true xor 3" @>
//        (expectedErrors [|6|]) //double reporting error since synthetic ifthenelse constructions in rexpr.
//
//[<Theory;EvalData>]
//let ``true xor true`` options =
//    test <@ C.evalWith options "true xor true" = false @>
//
//[<Theory;EvalData>]
//let ``true xor false`` options =
//    test <@ C.evalWith options "true xor false" = true @>
//
//[<Theory;EvalData>]
//let ``false xor true`` options =
//    test <@ C.evalWith options "false xor true" = true @>
//
//[<Theory;EvalData>]
//let ``false xor false`` options =
//    test <@ C.evalWith options "false xor false" = false @>
...
let ``not true`` options =
    test <@ C.evalWith options "!true" = false @>
...
let ``not false`` options =
    test <@ C.evalWith options "!false" = true @>
