...
let ``get static field`` options =
    test <@ C.evalWith options (Prelude.openAsm + "Tests.NonGenericClass1.static_field_int") = 0 @>
...
let ``set static field`` options =
    ...
    test <@ C.evalWith options (Prelude.openAsm + "Tests.NonGenericClass1.static_field_int <- 3; temp = Tests.NonGenericClass1.static_field_int in Tests.NonGenericClass1.static_field_int <- 0; temp") = 3 @> //TODO ';' should bind weaker than '<-'

[<Theory;EvalData>] //verifies IL standard optimization
let ``set static field with default of value type`` options =
    test <@ C.evalWith options (Prelude.openAsm + "Tests.NonGenericClass1.static_field_decimal3 <- default[decimal]; temp = Tests.NonGenericClass1.static_field_decimal3 in Tests.NonGenericClass1.static_field_decimal3 <- decimal(3); temp") = 0M @> //TODO ';' should bind weaker than '<-'

[<Theory;EvalData>]
let ``get struct instance field`` options =
    test <@ C.evalWith options (Prelude.openAsm + "Tests.NonGenericStruct1().instance_field_int") = 0 @>

[<Theory;EvalData>]
let ``assign struct instance field to var`` options =
    test <@ C.evalWith options (Prelude.openAsm + "x = Tests.NonGenericStruct1().instance_field_int in x") = 0 @>

[<Theory;EvalData>]
let ``get class instance field`` options =
    test <@ C.evalWith options (Prelude.openAsm + "Tests.NonGenericClass1().instance_field_int") = 0 @>

[<Theory;EvalData>]
let ``set struct instance field`` options =
    test <@ C.evalWith options (Prelude.openAsm + "ngs = Tests.NonGenericStruct1() in ngs.instance_field_int <- 3; ngs.instance_field_int") = 3 @>

[<Theory;EvalData>]
let ``set class instance field`` options =
    test <@ C.evalWith options (Prelude.openAsm + "ngc = Tests.NonGenericClass1() in ngc.instance_field_int <- 3; ngc.instance_field_int") = 3 @>

[<Theory;EvalData>]
let ``set class instance field with default of value type`` options =
    test <@ C.evalWith options (Prelude.openAsm + "x = Tests.NonGenericClass1() in x.instance_field_decimal3 <- default[decimal]; x.instance_field_decimal3") = 0M @>
...
let ``in place mutation of a instance class field`` options =
    test <@ C.evalWith options (Prelude.openAsm + "x = Tests.NonGenericClass1() in x.instance_field_ngc2.instance_field_int <- 3; x.instance_field_ngc2.instance_field_int") = 3 @>

[<Theory;EvalData>]
let ``in place mutation of a instance struct field`` options =
    test <@ C.evalWith options (Prelude.openAsm + "x = Tests.NonGenericClass1() in x.instance_field_ngs1.instance_field_int <- 3; x.instance_field_ngs1.instance_field_int") = 3 @>

[<Theory;EvalData>]
let ``incompatible static field assignment type`` options =
    raisesWith <@ C.evalWith options (Prelude.openAsm + "Tests.NonGenericClass1.static_field_int <- object()") @>
        (expectedErrors [|30|])

[<Theory;EvalData>]
let ``incompatible instance field assignment type`` options =
    raisesWith <@ C.evalWith options (Prelude.openAsm + "x = Tests.NonGenericClass1() in x.instance_field_int <- object()") @>
        (expectedErrors [|30|])
...
let ``set instance field of an expression is valid`` options = //but do we really want it to be?
    test <@ C.evalWith options (Prelude.openAsm + "Tests.NonGenericClass1().instance_field_int <- 0") = null @>